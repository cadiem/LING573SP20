...
if __name__ == '__main__':
    ...
    p.add_argument('--output_dir', default ='outputs/D3/')
    ...
    p.add_argument('--results_path', default='results/D3_rouge_scores.out')
    ...
    p.add_argument('--method', default='Transformer', help ='Options include:Transformer,Noun,Default,NoStop')
    p.add_argument('--dampening', type=float, default=0.2)
    p.add_argument('--threshold', type=float, default=0.0)
    p.add_argument('--epsilon', type=float, default=0.1)
    p.add_argument('--min_words', type=int, default=5)
    p.add_argument('--intrasentence_similarity', type=float, default=0.5)
    ...
    if args.do_summarize:
        ...
        selected_content = select_content(nlp,topics, args.word_vectors, args.method, args.dampening, args.threshold, args.epsilon, args.min_words, args.intrasentence_similarity)
