...
<<<<<<< HEAD
    p.add_argument('--model_dir', default = '/dropbox/19-20/573/models/training/2009')
    p.add_argument('--corpus_config', default = '/dropbox/19-20/573/Data/Documents/training/UpdateSumm09_test_topics.xml')
=======
