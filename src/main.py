...
if __name__ == '__main__':
    ...
    if args.do_summarize:
        ...
        selected_content = select_content(topics, args.word_vectors, args.method, args.dampening, args.threshold, args.epsilon, args.min_words, args.intrasentence_similarity)
