...
if __name__ == '__main__':
    ...
    p.add_argument('--corpus_dir', default = 'Data/')
    #p.add_argument('--corpus_dir', default = '/corpora/LDC/')
    p.add_argument('--output_dir', default ='outputs/D2/')
    #p.add_argument('--model_dir', default = '/dropbox/19-20/573/models/devtest/')
    #p.add_argument('--corpus_config', default = '/dropbox/19-20/573/Data/Documents/devtest/GuidedSumm10_test_topics.xml')
    p.add_argument('--model_dir', default = 'Data/models/devtest/')
    p.add_argument('--corpus_config', default = 'Documents/devtest/GuidedSumm10_test_topics.xml')
    ...
    p.add_argument('--rouge_config_file', default = 'src/ROUGE/devtest_config.xml')
    p.add_argument('--method', default='Noun', help ='Options include:Noun,Default,NoStop')
    p.add_argument('--dampening', type=float, default=0.7)
    p.add_argument('--threshold', type=float, default=0.2)
    p.add_argument('--epsilon', type=float, default=0.15)
    p.add_argument('--min_words', type=int, default=7)
    p.add_argument('--word_vectors', default='en_core_web_lg')
    p.add_argument('--run_id', default='42')
    args = p.parse_args()
