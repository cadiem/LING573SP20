...
PATH_MAPPING = {
    'AQUAINT': {
        ...
        'root': 'Data/LDC02T31' #'/corpora/LDC/LDC02T31/'
    },
    'AQUAINT-2': {
        # Do some regex matching to build a path
        # (tag)(year)(month)(day).(doc id)
        ...
        'root': 'Data/LDC08T25/data'#'/corpora/LDC/LDC08T25/data' #'./patas/AQUAINT-2/data' #'Data/LDC08T25/data' #Change this for patas folders aka /corpora/LDC/LDC08T25/data
    },
}
